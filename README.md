...
<a href="https://github.com/MacroMaster101?tab=followers">
  <!-- FOLLOWERS-BADGE:START --><img src="https://img.shields.io/badge/FOLLOWERS-3-6e40c9?style=for-the-badge&labelColor=0d1117&logo=github&logoColor=white" alt="Followers"/><!-- FOLLOWERS-BADGE:END -->
</a>
&nbsp;
<a href="https://github.com/MacroMaster101?tab=repositories">
  <!-- REPOS-BADGE:START --><img src="https://img.shields.io/badge/REPOS-16-6e40c9?style=for-the-badge&labelColor=0d1117&logo=git&logoColor=white" alt="Repos"/><!-- REPOS-BADGE:END -->
</a>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Fly.io-7B36ED?style=for-the-badge&logo=flydotio&logoColor=white"/>
...
<p><b>🎮 <a href="https://github.com/MacroMaster101/just-for-fun-website">Just For Fun — Gaming Hub</a></b></p>
<p>Official web hub for a Sri Lankan gaming crew. Next.js + Supabase + Prisma with live YouTube sync, admin tools & community highlights.</p>
<p>
...
<p>Full-stack mobile travel planner: trips, expenses, hotels, reviews & notifications over a secure REST API.</p>
<p>
...
<p>AI-assisted travel planning with personalized recommendations & itineraries via content-based filtering and rule-based logic.</p>
<p>
...
<td width="50%" valign="top">
<p><b>🦟 <a href="https://github.com/MacroMaster101/DengueRisk">DengueRisk — ML Prediction</a></b></p>
<p>ML model classifying dengue risk levels across Sri Lankan districts from weekly case data & weather features for early outbreak warning.</p>
<p>
...
<p>Self-hostable music bot powered by yt-dlp: search & URL playback, button controls, queue, loop/shuffle/volume & anti-bot cookie auth. Docker & Nixpacks ready.</p>
<p>
<img src="https://img.shields.io/badge/Node.js-339933?style=flat-square&logo=nodedotjs&logoColor=white"/>
...
<p>Secure Spring Boot voting system for academic award nominations with role-based access, real-time monitoring & email alerts. 6-member team project.</p>
<p>
...
<p>Modern portfolio with React 19, TypeScript, Vite & Tailwind. Live GitHub API project feed, category filtering, Framer Motion & dark mode.</p>
<p>
<img src="https://img.shields.io/badge/React-20232A?style=flat-square&logo=react&logoColor=61DAFB"/>
...
<td width="50%" valign="top">
<p><b>📚 <a href="https://github.com/MacroMaster101/home-tutor">Home Tutor</a></b></p>
<p>Java web application built with the Maven build tool, configured for SmartTomcat deployment & web setup.</p>
<p>
...
| [**Saloon_Vero_App**](https://github.com/MacroMaster101/Saloon_Vero_App) | 🔷 TypeScript | 💇‍♂️ A premium React Native + Expo SDK 54 mobile app for Vero Saloon. Features role-based dashboards (Cust… |
...
- 🛡️ **[J4F Server Bot](https://github.com/MacroMaster101/discord-j4fn-server-bot)** — Discord moderation suite (kick/ban/mute/warn/purge), anti-spam auto-mod & real-time web admin dashboard, deployed 24/7 on Fly.io.
